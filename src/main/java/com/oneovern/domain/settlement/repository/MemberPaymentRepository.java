...
public interface MemberPaymentRepository extends JpaRepository<MemberPayment,Long> {
    ...
    @Query(value="""
            SELECT mp.member_payment_id AS memberPaymentId,
                ...
                mp.payment_status AS paymentStatus, mp.payment_amount AS paymentAmount, ps.target_date AS targetDate
            FROM member_payment mp
                JOIN party_settlement ps ON mp.party_settlement_id=ps.party_settlement_id -- target_date 조회용
